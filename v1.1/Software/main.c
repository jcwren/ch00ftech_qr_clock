...
const unsigned char alpha2int[256] =	{1,2,4,8,16,32,64,128,29,58,116,232,205,135,19,38,76,152,45,90,\
...
const unsigned char int2alpha[256] = {0,0,1,25,2,50,26,198,3,223,51,238,27,104,199,75,4,100,224,14,52,141,\
...
******************************************/
	...
	while (j<13) //keep iterating until the final term of the polynomial has x^0
	{
        ...
        unsigned char topnonzero = firstnonzero(temp);
